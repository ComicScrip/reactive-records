...
var Collection = /** @class */ (function () {
    ...
    Collection.prototype.getPersistanceStrategy = function () {
    ...
    Collection.prototype.provideScope = function (name, params) {
        ...
        if (scope) {
            ...
            scope = new Scope_1.Scope(this, name);
            this.setScope(scope);
        }
        if (params) {
     ...
     */
    Collection.prototype.load = function (scopeName, params) {
        if (scopeName === void 0) { scopeName = "default"; }
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getPersistanceStrategy().loadMany(params, this.provideScope(scopeName, params))];
            });
        });
    };
    /**
     ...
     */
    Collection.prototype.loadOne = function (record, scopeName, params) {
        if (scopeName === void 0) { scopeName = "default"; }
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, r;
            return __generator(this, function (_b) {
                ...
                return [2 /*return*/, this.getPersistanceStrategy().loadOne(params, record, this.provideScope(scopeName, params))];
            });
        });
    };
    /**
     ...
     */
    Collection.prototype.saveOne = function (record, scopeName, params) {
        if (scopeName === void 0) { scopeName = "default"; }
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getPersistanceStrategy().saveOne(params, record, this.provideScope(scopeName, params))];
            });
        });
    };
    /**
     ...
     */
    Collection.prototype.destroyOne = function (record, scopeName, params) {
        if (scopeName === void 0) { scopeName = "default"; }
        if (params === void 0) { params = {}; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.getPersistanceStrategy().destroyOne(params, record, this.provideScope(scopeName, params))];
            });
        });
    };
    __decorate([
