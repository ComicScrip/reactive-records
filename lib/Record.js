...
var Record = /** @class */ (function () {
     ...
     */
    Record.prototype._load = function (scopeName, params) {
        if (scopeName === void 0) { scopeName = "default"; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._collection.loadOne(this, scopeName, params)];
            });
        });
    };
    /**
     ...
     * @param {object} params : params passed to the persistence service
     */
    Record.prototype._save = function (scopeName, params) {
        if (scopeName === void 0) { scopeName = "default"; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._collection.saveOne(this, scopeName, params)];
            });
        });
    };
    /**
     ...
     * @param {object} params : params passed to the persistence service
     */
    Record.prototype._destroy = function (scopeName, params) {
        if (scopeName === void 0) { scopeName = "default"; }
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this._collection.destroyOne(this, scopeName, params)];
            });
        });
    };
    /**
