...
var Record = /** @class */ (function () {
    ...
    function Record(collection) {
         ...
         */
        this._optimisticPrimaryKey = "optimistic_" + getRandomArbitrary(0, 9999999999999999999);
        /**
            ...
            var interceptArrayMutations = function (change) {
                ...
                if (change.removedCount > 0) {
                    ...
                    for (var j = change.index; j < change.removedCount; j++) {
                        var removed = existingAssociatedRecords[j];
     ...
     */
    Record.prototype._mergeProperties = function (properties) {
     ...
     * @param properties a plain object with the properties that will override this record's properties
     */
    Record.prototype._hydrateWith = function (properties) {
        for (var i = 0, propKeys = this._propertiesNames; i < propKeys.length; i++) {
            var propKey = propKeys[i];
            this[propKey] = properties[propKey];
        }
        return this;
    ...
    __decorate([
        mobx_1.action.bound
    ], Record.prototype, "_hydrateWith", null);
    __decorate([
        mobx_1.action.bound
